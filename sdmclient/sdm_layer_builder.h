...
public:
  ...
  DisplayError SetLayerBuffer(uint64_t display_id, int64_t layer_id,
                              const SnapHandle *buffer,
                              const shared_ptr<Fence> &acquire_fence) override;
  DisplayError SetLayerBlendMode(uint64_t display_id, int64_t layer_id,
                                 int32_t int_mode) override;
  DisplayError SetLayerDisplayFrame(uint64_t display_id, int64_t layer_id,
                                    SDMRect frame) override;
  DisplayError SetLayerPlaneAlpha(uint64_t display_id, int64_t layer_id,
                                  float alpha) override;
  DisplayError SetLayerSourceCrop(uint64_t display_id, int64_t layer_id,
                                  SDMRect crop) override;
  DisplayError SetLayerTransform(uint64_t display_id, int64_t layer_id,
                                 SDMTransform transform) override;
  DisplayError SetLayerZOrder(uint64_t display_id, int64_t layer_id,
                              uint32_t z) override;
  DisplayError SetLayerType(uint64_t display_id, int64_t layer_id,
                            SDMLayerTypes type) override;
  DisplayError SetLayerFlag(uint64_t display_id, int64_t layer_id,
                            SDMLayerFlag flag) override;
  ...
  DisplayError SetLayerColor(uint64_t display_id, int64_t layer_id,
                             SDMColor color) override;
  DisplayError SetLayerDataspace(uint64_t display_id, int64_t layer_id,
  ...
  DisplayError SetLayerPerFrameMetadataBlobs(uint64_t display_id,
                                             int64_t layer_id,
                                             uint32_t num_elements,
                                             const int32_t *int_keys,
                                             const uint32_t *sizes,
                                             const uint8_t *metadata) override;
  DisplayError SetLayerBrightness(uint64_t display_id, int64_t layer_id,
                                  float brightness) override;
  DisplayError SetLayerAsMask(uint64_t display_id, int64_t layer_id) override;
  SDMCompositionType
  GetDeviceSelectedCompositionType(uint64_t display_id,
                                   int64_t layer_id) override;
  DisplayError SetCursorPosition(uint64_t disp_id, int64_t layer_id, int32_t x,
                                 int32_t y) override;
