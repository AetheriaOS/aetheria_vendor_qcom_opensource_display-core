...
class SnapMetadataManager {
 ...
 private:
  ...
  bool IsMetadataTypeSettable(vendor_qti_hardware_display_common_MetadataType type);
  ...
  std::unordered_map<vendor_qti_hardware_display_common_MetadataType, metadata_traits>
      metadatatype_traits_map{
          {BUFFER_ID, {true, false}},
          {NAME, {true, false}},
          {WIDTH, {true, false}},
          {HEIGHT, {true, false}},
          {LAYER_COUNT, {true, false}},
          {PIXEL_FORMAT_REQUESTED, {true, false}},
          {PIXEL_FORMAT_FOURCC, {true, false}},
          {DRM_PIXEL_FORMAT_MODIFIER, {true, false}},
          {USAGE, {true, false}},
          {ALLOCATION_SIZE, {true, false}},
          {PROTECTED_CONTENT, {true, false}},
          {COMPRESSION, {false, false}},
          {INTERLACED, {false, false}},
          {CHROMA_SITING, {false, false}},
          {PLANE_LAYOUTS, {true, false}},
          {CROP, {false, true}},
          {DATASPACE, {true, true}},
          {BLEND_MODE, {false, true}},
          {VT_TIMESTAMP, {false, true}},
          {PP_PARAM_INTERLACED, {false, true}},
          {VIDEO_PERF_MODE, {false, true}},
          {GRAPHICS_METADATA, {false, true}},
          {UBWC_CR_STATS_INFO, {false, true}},
          {REFRESH_RATE, {false, true}},
          {MAP_SECURE_BUFFER, {false, true}},
          {LINEAR_FORMAT, {false, true}},
          {SINGLE_BUFFER_MODE, {false, true}},
          {CVP_METADATA, {false, true}},
          {VIDEO_HISTOGRAM_STATS, {false, true}},
          {FD, {true, false}},
          {ALIGNED_WIDTH_IN_PIXELS, {true, false}},
          {ALIGNED_HEIGHT_IN_PIXELS, {true, false}},
          {STANDARD_METADATA_STATUS, {true, true}},
          {VENDOR_METADATA_STATUS, {true, true}},
          {BUFFER_TYPE, {true, false}},
          {VIDEO_TS_INFO, {false, true}},
          {CUSTOM_DIMENSIONS_STRIDE, {true, false}},
          {CUSTOM_DIMENSIONS_HEIGHT, {true, false}},
          {RGB_DATA_ADDRESS, {true, false}},
          {BUFFER_PERMISSION, {false, true}},
          {MEM_HANDLE, {true, false}},
          {TIMED_RENDERING, {false, true}},
          {CUSTOM_CONTENT_METADATA, {false, true}},
          {VIDEO_TRANSCODE_STATS, {false, true}},
          {EARLYNOTIFY_LINECOUNT, {false, true}},
          {RESERVED_REGION, {false, false}},
          {FORMAT_MODIFIER, {false, false}},
          {MASTERING_DISPLAY, {false, true}},
          {CONTENT_LIGHT_LEVEL, {false, true}},
          {DYNAMIC_METADATA, {false, true}},
          {MATRIX_COEFFICIENTS, {false, true}},
          {COLOR_REMAPPING_INFO, {false, true}},
          {BASE_ADDRESS, {true, false}},
          {IS_UBWC, {true, false}},
          {IS_TILE_RENDERED, {true, false}},
